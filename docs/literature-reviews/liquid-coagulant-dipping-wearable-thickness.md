...
> **Safety.** Acetic coagulants need PPE. Add acid to water, not the reverse. Warm leach is required. No copper or brass fittings in dip or leach contact. See [Allergy and Skin Contact](/literature-reviews/allergy-and-skin-contact).
...
Primary levers are [coacervant strength](#coacervant-families), [dwell time](#dwell-thickness) (deposit often follows square-root-of-time kinetics), compound viscosity, and withdrawal speed. Follow with warm-water leach and [humidity-aware dry](#leach-humidity). Use this after [Former dip, mould cast, and flat spread](/literature-reviews/liquid-former-dip-vs-mould-cast-vs-flat-spread) routes you to a former.

---

## When coagulant beats straight multi-dip {#when-coagulant}
...
<details>
<summary>What is a coacervant?</summary>
...
## Coacervant families {#coacervant-families}
...
## Dwell time and thickness {#dwell-thickness}
...
## Stability, pinholes, and air {#stability-pinholes}
...
## Leach, humidity, and second dip {#leach-humidity}
...
When a deposit fails, name it: [Liquid film defects](/literature-reviews/liquid-film-defect-atlas).
...
<details>
<summary>Deep dive: Coacervant base formulations (plant examples)</summary>
