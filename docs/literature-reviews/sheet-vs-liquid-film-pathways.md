...
description: Two pathways that must not be mixed — calendered sheet vs liquid-to-film — with do-not-mix examples and a vocabulary map.
...
Use this when a bottle of concentrate is treated like bought sheet, or bought sheet is treated like a [coagulant dip](#do-not-mix-1-coagulant-dip-on-bought-sheet). You get a [vocabulary map](#vocabulary-map), [five do-not-mix examples](#do-not-mix-examples), and [decision cues](#when-to-choose-which-path) for choosing a path.

---

## Define sheet-based work vs liquid latex work {#define-pathways}
...
For glue after the film exists, see [Adhesives and Seam Integrity](/literature-reviews/adhesives-and-seam-integrity). For storage once film exists, see [Aging, Storage and Care](/literature-reviews/aging-storage-and-care).

---

## Shared knowledge vs path-specific domains {#shared-vs-specific}
...
| Allergy *classes* (protein vs chemicals) | Literacy yes | See [Allergy review](/literature-reviews/allergy-and-skin-contact) | Dipped-goods leach documented industrially |
...
## Do-not-mix examples {#do-not-mix-examples}

Five mismatches. Each is industrial- or standards-sourced.

### 1. Coagulant dip economics applied to bought sheet {#do-not-mix-1-coagulant-dip-on-bought-sheet}
...
### 2. Prevulc “dry only” applied to raw / unvulcanized concentrate {#do-not-mix-2-prevulc-dry-only}
...
### 3. ASTM D3578 / D5151 treated as fashion-sheet certification {#do-not-mix-3-glove-specs-on-sheet}
...
### 4. Nitrile coagulant-dip TDS treated as Hevea NR liquid latex work {#do-not-mix-4-nitrile-on-nr}
...
### 5. Styrene-acrylic construction dispersion treated as prevulcanized NR {#do-not-mix-5-acrylic-not-nr}
...
## When to choose which path (hobby decision cues) {#when-to-choose-which-path}
...
For textile bonds after the film exists, see [Latex Textile Bonding](/literature-reviews/latex-textile-bonding). For adhesives, see [Adhesives and Seam Integrity](/literature-reviews/adhesives-and-seam-integrity).
