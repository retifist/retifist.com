...
description: Type I protein vs Type IV chemical reactions, what labels do and do not mean, and when to stop and seek care — literacy, not medical advice.
...
## What is in the film (categories, not personal risk scores) {#what-is-in-the-film}
...
## What labels mean (devices vs fashion) {#what-labels-mean}
...
## Food-contact FDA ≠ wear certification {#food-contact-fda}
