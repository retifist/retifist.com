...
Use this when you are picking an ink or transfer for [calendered](#bought-face) sheet, or when a vendor photo is doing more work than a stretch number. Pair with [Sheet Surface Finish](/literature-reviews/sheet-surface-finish-literacy) for the face you actually bought, and [Pigment and Filler Decks](/literature-reviews/sheet-pigment-filler-decks) if you would rather color the rubber itself than print on top.

---

## Why sheet is a hard print substrate {#hard-substrate}

Vulcanized latex film has to stretch to at least twice its length under stress and then recover. That is the industrial bar for an elastomeric film. Cotton screen ink and rigid plastisol were not designed for that motion. Until a stretch spec or a [coupon test](#decision-cues) says otherwise, treat a textile ink as the wrong class.
...
| ASTM D3389 | Coated-fabric abrasion (mass loss / cycles) |
| ASTM D1876 | T-peel on flexible bonds |

Treat the ink as a thin coating on rubber. A stretch coupon on your actual sheet, plus a peel or cross-cut attempt, is the shop version of that vocabulary. See [Adhesives and Seam Integrity](/literature-reviews/sheet-adhesives-and-seam-integrity) for peel language.

---

## The face you bought {#bought-face}
...
**Calendered** latex sheet is pressed to even thickness between heated rollers at the factory. You buy it ready to cut and glue. The two faces are whatever the mill sold. See [Sheet Surface Finish](/literature-reviews/sheet-surface-finish-literacy) before you treat shine alone as “the print side.”
