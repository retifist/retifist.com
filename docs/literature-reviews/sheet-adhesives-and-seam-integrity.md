...
> **Safety.** Heptane and light-aliphatic rubber cements are flammable liquids. Read the **product** SDS. Keep cans closed, away from heat and sparks. A cracked window is not enough. See [Sheet ventilation and solvent exposure](/literature-reviews/sheet-ventilation-solvent-exposure).
...
Use this when you are [joining sheet to sheet](#q1-substrate), [gluing fabric onto sheet](#q1-substrate), or [reading a seam that already peeled](#reading-a-failed-seam). Pick a family first. Brand second.
...
Walk these once. The [decision tree](#decision-tree) uses them.
...
<details>
<summary>What are tack and contact bond?</summary>
...
On **porous** fabric, the bond is mostly mechanical if the cement can flow into the weave. Cotton duck is that job. Smooth nylon taffeta behaves more like a non-porous face: polarity (or a pretreat) matters more than “more glue.” See [Sheet latex–textile bonding](/literature-reviews/sheet-latex-textile-bonding).
...
Rubber dissolved in organic solvent. Sheet culture: coat, [flash off](#flash-off), contact.

**Why people pick it:** water resistance; a wide range of drying rates and [open times](#open-time); high early bond strength and tack; wets some difficult (slick) surfaces.
...
## Contamination on the bond face {#contamination}
...
Sheet–sheet: treat fashion NR as a [smooth, low-polarity face](#polarity). Solvent cement is the family that is documented to wet difficult surfaces and to offer early tack.

Sheet–fabric: thirsty cotton can take a mechanical key if cement enters the pores. Smooth nylon does not. That split is [Sheet latex–textile bonding](/literature-reviews/sheet-latex-textile-bonding), not a reason to switch families on a whim.

### Q2 — contamination {#q2-contamination}

See [Contamination](#contamination).

### Q3 — ventilation / fire {#q3-ventilation-fire}

If you cannot handle an open can as flammable-liquid work, the tree already stops you. Details: [Safety](#safety) and [Sheet ventilation](/literature-reviews/sheet-ventilation-solvent-exposure).

### Q4 — stretch lap vs static lap {#q4-stretch}

Lab peel tests classify how a bond breaks. They are not a pass/fail grade for a catsuit seam. A [stretch lap](#lap) wants geometry that does not hand the wearer a peel start: more overlap, no raw knife-edge at a crease, no [notch](#notch) at the end of the glue line.

---

## Reading a failed seam {#reading-a-failed-seam}

You can sort many peels by eye. Pair with [Sheet delamination](/literature-reviews/sheet-delamination-seam-failure).

### Glue on one side vs glue split

**Adhesive failure:** one face looks clean; all the dried cement stayed on the other piece. Think prep, [contamination](#contamination), polarity mismatch, or a face that never wetted.
...
An edge that always starts the peel is often [lap geometry](#lap) as much as chemistry. Mid-panel pop after wear may be stretch, a dirty face, or cement that was still **green** (under-dried).

<details>
<summary>What does green mean for cement?</summary>
...
Fibers pulled out of the cloth: the bond beat the textile. Rubber torn beside the seam: the sheet failed first. Neither one is automatically “use more cement.” Check [notch](#notch) and [lap](#lap) before you thicken the glue line.
...
**Skin / allergy.** This page is not medical advice. “Skin-safe” on a can is not allergy clearance. See [Allergy and skin contact](/literature-reviews/allergy-and-skin-contact).
...
<details>
<summary>Deep dive: Solvent cement trade-offs (handbook)</summary>
...
<details>
<summary>Deep dive: Polarity matching with examples</summary>
...
Mixed-polarity stacks (NR sheet on nylon) may need a blend or a resin bridge. That is industrial textile chemistry, not a bottle on a hobby shelf. See [Sheet latex–textile bonding](/literature-reviews/sheet-latex-textile-bonding).

</details>

<details>
<summary>Deep dive: Peel vocabulary</summary>
