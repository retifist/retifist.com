...
> **Safety.** Water-based is not the same as harmless. Latex adhesives can freeze, shrink fabrics, and still carry **ammonia**. Read the **product** SDS. See [Liquid ventilation and ammonia](/literature-reviews/liquid-ventilation-ammonia).
...
Use this when you are [joining film to film](#q1-substrate), [combining fabric](#q5-wet-vs-dry), or [reading a join that peeled](#reading-a-failed-join).
...
### Wet combining and dry combining {#wet-vs-dry}
...
### Polarity and porous flow {#polarity}
...
Cotton duck: thirsty, fiber ends stick out, mechanical key is the industrial story. Smooth nylon: little mechanical key. See [Liquid latex–textile bonding](/literature-reviews/liquid-latex-textile-bonding).
...
## Contamination from containers and tools {#contamination}
...
## What goes in the glue (handbook examples) {#modifiers}
...
| --- | --- | --- |
| Resins / tackifiers | Quick grab and longer tack life; more useful in [dry combining](#wet-vs-dry) | Piccolyte A85 (PSA study); phenolic resin (one nylon-peel paper, about 3 phr in that system); rosin acid soap; tackifying-resin emulsion at 50–100 dry parts in a dry-combining example |
...
4. Wet combine or dry combine?
   ...
   └─ Coat, dry to tack, then marry → dry combining (tackifiers more typical)
```

### Q1 — substrate {#q1-substrate}

Film–film: aqueous latex adhesive is the documented family. Restricted [coalescence](#executive-summary) can leave a weaker film than a solvent solution.

Film–fabric: see [polarity and porous flow](#polarity) and [Liquid latex–textile bonding](/literature-reviews/liquid-latex-textile-bonding).

### Q2 — contamination {#q2-contamination}

See [Contamination](#contamination).

### Q3 — stretch lap vs static lap {#q3-stretch}

Lab peel tests classify fracture. They are not a garment grade. A [stretch lap](#lap) wants less peel start at the edge. A [notch](#notch) in the film is a design problem, not a glue-volume problem.

### Q4 — wet vs dry {#q5-wet-vs-dry}
...
## Reading a failed join {#reading-a-failed-join}

Pair with [Liquid delamination](/literature-reviews/liquid-delamination-seam-failure).

**Adhesive failure:** one face clean; glue all on the other. Prep, [contamination](#contamination), polarity mismatch, or never wetted.
...
**Ply split** on a multi-dip piece (the layers come apart, not the glue line): the underlayer was dried or leached before the next dip, or humidity was too low. That is [Liquid reinforcement](/literature-reviews/liquid-reinforcement-laminate-zones), not “more glue.”

**Fabric fuzz vs rubber tear:** fibers in the glue means the bond beat the cloth. Film torn beside the join means the rubber failed first. Check [notch](#notch) and [lap](#lap).
...
**Skin / allergy.** Not medical advice. See [Allergy and skin contact](/literature-reviews/allergy-and-skin-contact).
...
<details>
<summary>Deep dive: Latex vs solution adhesive (handbook)</summary>
...
<details>
<summary>Deep dive: Wet combining example (plant card, not a home mix)</summary>
...
<details>
<summary>Deep dive: Tire-cord pretreat in plain language</summary>
...
That is strategy (pre-treat the textile), not a hobby formula. Full lineage: [Liquid latex–textile bonding](/literature-reviews/liquid-latex-textile-bonding).
