...
> **Safety.** Sheet work that uses solvent rubber cement is a fire, explosion, and fume class. Read the **product** SDS. Ventilate. Keep away from heat and sparks. See [Sheet adhesives](/literature-reviews/sheet-adhesives-and-seam-integrity) and [Sheet ventilation](/literature-reviews/sheet-ventilation-solvent-exposure). Natural-rubber protein and accelerator chemistry can matter for skin; that is literacy, not a wear certificate. See [Allergy and skin contact](/literature-reviews/allergy-and-skin-contact).

## Executive summary

You bought commercial sheet and you are gluing on a lining, panel, or trim. Cotton can grab rubber through fiber ends. Nylon often does not. Use this when a [lining lifts](#reading-peel), when [cotton “grabs” and nylon does not](#cotton-vs-nylon), or when you are about to treat a handbook combining table as a hobby mix card. Those tables are plant cards. They are not a lining recipe.
...
### Contact bond {#contact-bond}

Sheet culture for this job is usually **solvent rubber cement** as a contact bond: coat, [flash off](/literature-reviews/sheet-adhesives-and-seam-integrity#flash-off), press. Glue-family tree: [Sheet adhesives](/literature-reviews/sheet-adhesives-and-seam-integrity).

---

## Cotton vs nylon {#cotton-vs-nylon}
...
Higher filler in an adhesive raises viscosity and **decreases** flow into porous surfaces. That is a plant compounding note. It is also why a chalky, over-thick cement can fail on cotton you expected to “just grab.”

---

## Reading peel {#reading-peel}
...
| Edge lifts in a stretch zone | Edge lift — geometry / stretch at the [lap](#lap) |

Failed-seam vocabulary: [Sheet delamination](/literature-reviews/sheet-delamination-seam-failure).

---

## Pretreat strategy (not a tire-dip card)

Pre-treating textile so rubber will stick is engineered adhesion. Industrial bonding agents include latex–casein and latex–resorcinol–formaldehyde (RFL). RFL is a heat-cure factory dip for cord. It is not room-temperature solvent cement. The shared *idea* is “wake the cloth up so rubber can wet it.” The chemistry is not the same. Plain-language RFL write-up: [Liquid latex–textile bonding](/literature-reviews/liquid-latex-textile-bonding).

---

## Safety {#safety}

Solvent cement: fire, explosion, fumes. Product SDS. Closed cans. [Sheet ventilation](/literature-reviews/sheet-ventilation-solvent-exposure).

Skin / allergy: [Allergy and skin contact](/literature-reviews/allergy-and-skin-contact).
...
<details>
<summary>Deep dive: Polarity ladder on a lining face</summary>
