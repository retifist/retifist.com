...
description: Why latex and fabric come apart — cotton vs nylon, wet vs dry combining, peel literacy, and stretch mismatch at the bond edge.
...
Use this when a [lining lifts](#reading-peel-delamination), when [cotton “grabs” and nylon does not](#cotton-vs-nylon), or when a handbook combining table is about to be treated as a hobby mix card. You get [decision cues](#decision-cues), [cotton vs nylon comparison](#cotton-vs-nylon), and [peel literacy](#reading-peel-delamination) in one place.
...
For pathway definitions, see [Sheet vs Liquid Film Pathways](/literature-reviews/sheet-vs-liquid-film-pathways). For aging of lined garments, see [Aging, Storage and Care](/literature-reviews/aging-storage-and-care).

---

## Cotton vs nylon in plain language {#cotton-vs-nylon}
...
| --- | --- | --- |
| Face, in maker language | Thirsty, fuzzy fiber ends | Smoother continuous filament |
| Industrial bond idea | Mechanical embed of fiber ends in rubber | Poor mechanical bond; needs polarity / chemical bridge |
| Water-based adhesive | Can wet pores; **shrink** risk on textiles | Same shrink class if aqueous; slick face may not take a mechanical key |
| Stretch | Woven cotton often stiffer than fashion NR | Knits often more mobile; mismatch at the bond edge |
...
## Decision cues (family + prep, not a SKU) {#decision-cues}

Output is a **family + prep branch**. Point to [Adhesives and Seam Integrity](/literature-reviews/adhesives-and-seam-integrity) for the glue-family tree.
...
## Reading peel / delamination {#reading-peel-delamination}
...
| What you see | Literacy label | What this pack can say |
| --- | --- | --- |
| Glue stays on one side; clean lift | Adhesive (interface) | Useful shop talk aligned with peel vocabulary |
| Glue splits; residue on both | Cohesive (in the adhesive) | Same |
| Fibers pull out of the cloth | Fiber pull | Mechanical-bond logic for cotton |
...
| Class | What to treat as real |
| --- | --- |
| Solvent cement | Fire hazard; explosion hazard; fume/health; ventilating equipment in the industrial comparison |
| Water-based / latex adhesive | Freeze; **shrinks fabrics**; slower dry; poorer water resistance vs solvent column |
...
<details>
<summary>Deep dive: Polarity and porous-flow</summary>
