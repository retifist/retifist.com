...
description: Thickness, stiffness, and pattern geometry as separate levers — industrial curves for sheet-based and liquid latex work.
series: literature-reviews
---

# Gauge, Modulus & Reduction: Fit Science
...
Use this when thickness and tight-fit lore get mixed up, when [fillers change feel](/literature-reviews/pigment-filler-decks-wearable-nr-film#loading-tradeoffs), or when comparing [bought sheet vs home-cast film](/literature-reviews/calendered-sheet-vs-home-cast-film).
...
| --- | --- |
| **Gauge** | Thickness (mm or mil) |
| **Modulus** | Stiffness at a given extension (MPa at 300%, etc.) |
| **Reduction** | Pattern geometry — negative ease built into the flat pieces |
...
## Sheet-based work — thickness {#sheet-thickness}
...
See [Calendered Sheet vs Home-Cast Film](/literature-reviews/calendered-sheet-vs-home-cast-film).

---

## Liquid latex work — modulus levers {#modulus-levers}
...
See [Pigment & Filler Decks](/literature-reviews/pigment-filler-decks-wearable-nr-film) for loading tables.
...
| pphr | Modulus 300% (MPa) | Tear (N/cm) | Set (%) |
| --- | --- | --- | --- |
| 0 | 0.90 | 1156 | 6 |
| 20 | 2.76 | 1769 | 30 |
...
<details>
<summary>Deep dive: DIXIE clay filler curve</summary>
