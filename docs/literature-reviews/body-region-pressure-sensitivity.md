...
description: Acuity, pressure-pain threshold, and preferred clothing pressure are three different body maps. Do not average them for garment fit.
series: literature-reviews
tags: [pressure, comfort, psychophysics, leftover]
---
...
```mermaid
flowchart TD
    A[Tactile Acuity / Detection] -->|Guides| D[Seam, zipper, and ridge placement]
    B[Pressure-Pain Threshold] -->|Sets| E[Safety limits for collars and bands]
    C[Preferred Clothing Pressure] -->|Budgets| F[Pattern reduction and panel tension]
```
...
<details>
<summary>Detail: What clothing pressure measures</summary>
...
<details>
<summary>Detail: Why sensitivity units cannot be averaged</summary>
...
<details>
<summary>Detail: Friction, modulus, and open research needs</summary>
