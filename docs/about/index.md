...
1. **Small examples** — short builds that teach one skill cleanly (a glued bow on a strap, a single seam wait you can actually watch).
2. **Small projects** — desk-scale pieces you can finish without a full workshop (Start Small’s sock over a shoe you already own).
...
Contact email will land here once the public address is wired.
